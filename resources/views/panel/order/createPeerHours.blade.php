        ...
        <div class="col-md-12">
            <h3 class="card-title">
                <div class="form-group row align-items-center">
                    <button type="button" @click="addRows" class="btn btn-success mr-2 btn-sm"><i class="fas fa-plus"></i></button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2">
                                <label>@lang('order.block')
                                    <span class="text-danger">*</span></label>
                                <input v-model="fileds[index].block" :disabled="fileds[index].showField" autocomplete="off" value="{{old('block')}}" type="text" class="form-control @error('block') is-invalid @enderror" name="block" placeholder="@lang('order.block')" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2 mt-5">
                                <label for="exampleSelect1">@lang('order.date_to')
                                    <span class="text-danger">*</span></label>
                                <div class="input-daterange input-group @error('start') is-invalid @enderror">
                                    <input :disabled="fileds[index].showField" v-on:change="onChangeDateTo(index)" v-model="fileds[index].date_to" :min="fileds[index].date_from" autocomplete="off" type="date" class="form-control"/>
                                </div>
                            ...
                            <div class="col-lg-2 mt-5">
                                ...
                                <div class="input-daterange input-group @error('start') is-invalid @enderror">
                                    ...
                                    <input :disabled="fileds[index].showField" v-on:change="onChangeTimeTo(index)" @change="updateValidationTo(index)" v-model="fileds[index].time_to" autocomplete="off" type="time" class="form-control"/>
                                </div>
