...
@push('js')
    ...
    <script>
        var data_table_url = '{!!route('delivery.datatable')!!}';
        ...
        $(document).ready(function() {
            Table.DataTable({
                ...
                columns: [
                    ...
                    {className: 'text-center', data: 'code', name: 'code', orderable: true, searchable: true},
                    @permission('delivery_update')
                    {className: 'text-center', data: 'b_enabled', name: 'b_enabled', orderable: true, searchable: true},
                    @endpermission
                    @permission(['delivery_delete|delivery_update'])
...
@section('pageTitle')
    ...
    <span class="text-muted font-weight-bold mr-4">@lang('navbar.delivery')</span>
    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{route('delivery.create')}}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap" id="data_table">
                ...
                <tr>
                    ...
                    @permission('delivery_update')
                    <th class="text-center" style="width: 15%">@lang('deliveryTable.status')</th>
                    @endpermission
                    @permission(['delivery_delete|delivery_update'])
