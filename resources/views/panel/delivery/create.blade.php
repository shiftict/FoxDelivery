...
@section('content')
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M0.00065168429,20.1992055 C0.388258525,15.4265159 4.26191235,13 8.98334134,13 C13.7712164,13 17.7048837,15.2931929 17.9979143,20.2 C18.0095879,20.3954741 17.9979143,21 17.2466999,21 C13.541124,21 8.03472472,21 0.727502227,21 C0.476712155,21 -0.0204617505,20.45918 0.00065168429,20.1992055 Z" fill="#000000" fill-rule="nonzero"/>
                ...
                <!--begin::Form-->
                <form method="post" action="{{Route('delivery.store')}}" id="driver_form">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" value="{{old('name')}}" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="@lang('delivery.namePlaceholder')" />
                                @error('name')
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input value="{{old('phone')}}" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="@lang('delivery.phonePlaceholder')" />
                                </div>
                                @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-lg-4">
                                <label>@lang('store.password')
                                    <span class="text-danger">*</span></label>
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="@lang('store.passwordPlaceholder')" />
                                @error('password')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label for="exampleSelect1">@lang('delivery.code')
                                    <span class="text-danger">*</span></label>
                                <input value="{{old('code')}}" type="text" class="form-control @error('code') is-invalid @enderror" name="code" placeholder="@lang('delivery.code')" />
                                @error('code')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
