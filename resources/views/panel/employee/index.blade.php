...
@push('js')
    ...
    <script>
        let add_edit_url = '{!!route('users.datatable.vendor')!!}';
        let data_table_url = '{!!route('users.datatable.vendor')!!}';
    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <a href="{{route('users.create.vendor')}}" class="btn btn-primary font-weight-bolder">
