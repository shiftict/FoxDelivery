...
@push('js')
    ...
    <script>
        let add_edit_url = '{!!route('employee.order.datatable')!!}';
        let data_table_url = '{!!route('employee.order.datatable')!!}';
        ...
        $(document).ready(function() {
            Table.DataTable({
                ...
                columns: [
                    ...
                    {className: 'text-center', data: 'delivery', name: 'delivery', orderable: false, searchable: true},
        ...
        <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3">
                            ...
                            <select class="form-control col-sm-12" name="b_enabled" id="b_enabled">
                                <option value="">--</option>
                                <option value="">--</option>
                                @foreach(App\Models\StatusSystem::where('status', '1')->get() as $vendor)
                                    <option value="{{ $vendor->id }}">{{ $vendor->name }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap" id="data_table">
                ...
                <tr>
                    ...
                    <th class="text-center" style="width: 10%">@lang('areaTable.text_status')</th>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="mb-5">
                                <select class="form-control mt-3 col-sm-12 status_driver" name="status_driver" id="status_driver">
                                    ...
                                    <option class="status_drive_option" value="0">@lang("table.pending")</option>
                                    <option class="status_drive_option" value="1">@lang("table.tripHasStarted")</option>
                                    <option class="status_drive_option" value="2">@lang("table.received")</option>
                                    <option class="status_drive_option" value="3">@lang("table.sentDeliveredHanded")</option>
                                    <option class="status_drive_option" value="4">@lang("table.cancellation")</option>
                                </select>
                            </div>
                            <div class="mb-5">
