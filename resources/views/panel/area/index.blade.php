...
@endpush
@push('js')
    <script src="{{asset('panel/assets/plugins/custom/datatables/datatables.bundle.js')}}"
            type="text/javascript"></script>

    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script>
        let add_edit_url = '{!!route('area.datatable')!!}';
        let data_table_url = '{!!route('area.datatable')!!}';
        ...
        $(document).ready(function () {
            Table.DataTable({
                ...
                columns: [
                    ...
                    @endpermission
                    @permission(['area_update|area_delete'])
        ...
        function showModal(id, modal_id, url, token, validate) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        $('#' + modal_id).html(data.page).modal('show', {
                            dismissible: false,
                            focus: false,
                            backdrop: 'static',
                            keyboard: false
...
@section('pageTitle')
    ...
    <span class="text-muted font-weight-bold mr-4">@lang('navbar.area')</span>
    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    <span class="fas fa-map-marked-alt icon-lg"></span>
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Dropdown-->
                <button style="margin: 0 10px 0 10px" id="btn_show_search_box" onclick="check_collapse()"
                        class="btn btn-light-primary font-weight-bolder" type="button" data-toggle="collapse"
        ...
        <div class="card-body">
            ...
            <div class="collapse col-xl-12" id="collapseExample">
                <div class="mb-7" id="filter_options">
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <label for="s_name" class="form-control-label">@lang('table.search_city_name')</label>
                            <input type="text" class="form-control" name="s_name" id="s_name"
                                   placeholder="@lang('table.search_city_name')"/>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 mt-5">
                            <a href="javascript:;" style="width: 100%"
                               class="btn btn-light-primary px-6 font-weight-bold search_btn">
                        ...
                        <div class="col-lg-3 mt-5">
                            <a href="javascript:;" style="width: 100%"
                               class="btn btn-light-dark px-6 font-weight-bold reset_form">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap"
                ...
                <tr>
                    ...
                    <th class="text-center">@lang('areaTable.name')</th>
                    @permission('area_update')
