...
@push('js')
    ...
    <script>
        let add_edit_url = '{!!route('method_shipping.datatable')!!}';
        let data_table_url = '{!!route('method_shipping.datatable')!!}';
        ...
        Table.DataTable({
            ...
            columns: [
                ...
                @permission('method_shipping_update')
                {className: 'text-center', data: 'b_enabled', name: 'b_enabled', orderable: true, searchable: true},
                @endpermission
                @permission(['method_shipping_update|method_shipping_delete'])
...
@endpush
@section('subTitle')
    @lang('delivery.shippingMethod')
@endsection
@section('pageTitle')
    <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
    <span class="text-muted font-weight-bold mr-4">@lang('delivery.shippingMethod')</span>
    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    <span class="fas fa-truck icon-lg"></span>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                {{--				<a href="javascript:;" onclick="showModal(null,'add_edit','{{ route('admin.services.form')}}','{{csrf_token()}}')" class="btn btn-primary font-weight-bolder">--}}
                    ...
                    <a href="{{route('method_shipping.create')}}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <div class="collapse col-xl-12" id="collapseExample">
                <div class="mb-7" id="filter_options">
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <label for="s_name" class="form-control-label">@lang('methodShippingTable.titleSearch')</label>
                            <input type="text" class="form-control" name="s_name" id="s_name" placeholder="@lang('methodShippingTable.titleSearchPlaceholder')"/>
                        </div>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap" id="data_table">
                ...
                <tr>
                    ...
                    <th class="text-center">@lang('methodShippingTable.name')</th>
                    <th class="text-center">@lang('cityTable.price')</th>
                        @permission('method_shipping_update')
                        <th class="text-center" style="width: 10%">{{trans('methodShippingTable.text_status')}}</th>
                        @endpermission
                        @permission(['method_shipping_update|method_shipping_delete'])
                        <th class="text-center" style="width: 10%">{{trans('methodShippingTable.text_options')}}</th>
                        @endpermission
                </tr>
                </thead>
            </table>
...
@push('js')
    ...
    <script src="{{asset('panel/assets/plugins/custom/datatables/datatables.bundle.js?v=7.0.4')}}" type="text/javascript"></script>
{{--    <script src="{{ asset('panel/datatables/datatables.bundle.js') }}"></script>--}}
