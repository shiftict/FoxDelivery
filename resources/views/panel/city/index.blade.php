...
@push('js')
    ...
    <script>
        let add_edit_url = '{!!route('city.datatable')!!}';
        let data_table_url = '{!!route('city.datatable')!!}';
        ...
        $(document).ready(function() {
            Table.DataTable({
                ...
                columns: [
                    ...
                    {className: 'text-center', data: 'area', name: 'area', orderable: true, searchable: true},
                    ...
                    @endpermission
                    @permission(['city_update|city_delete'])
        ...
        <div class="card-body">
            ...
            <div class="collapse col-xl-12" id="collapseExample">
                <div class="mb-7" id="filter_options">
                    <div class="form-group row">
                        <div class="col-lg-3">
                            <label for="s_name" class="form-control-label">@lang('table.search_area_name')</label>
                            <input type="text" class="form-control" name="s_name" id="s_name" placeholder="@lang('table.search_area_name')"/>
                        </div>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap" id="data_table">
                ...
                <tr>
                    ...
                    <th class="text-center">@lang('cityTable.area')</th>
                    <th class="text-center" style="width: 10%">@lang('users.city_name')</th>
                    <th class="text-center" style="width: 10%">@lang('cityTable.price')</th>
                    @permission('city_update')
