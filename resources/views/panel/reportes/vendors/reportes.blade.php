...
@push('js')
    ...
    <script>
        var data_table_url = '{!!route('vendors.datatable')!!}';
        ...
        $(document).ready(function() {
            Table.DataTable({
                ...
                columns: [
                    ...
                    {className: 'text-center', data: 'user', name: 'user', orderable: true, searchable: true},
                    // {className: 'text-center', data: 'days', name: 'days', orderable: true, searchable: true},
                    {className: 'text-center', data: 'address', name: 'address', orderable: true, searchable: true},
        ...
        $('#xls_report').on('click', function() {
            $('#submit_filter_w').attr('action', '{{Route("vendor.vendorXLSFilter")}}').submit();
        })
    </script>
@endpush
@section('subTitle')
        ...
        <div class="card-body">
            ...
            <div class="collapse col-xl-12" id="collapseExample">
                <div class="mb-7" id="filter_options">
                    <form id="submit_filter_w" method="post" action="{{Route('vendor.printPdfFilter')}}">
                            @csrf
...
{{--                    <th class="text-center">@lang('store.method')</th>--}}
                    <th class="text-center" style="width: 15%">@lang('deliveryTable.address')</th>
