    ...
    <script>
        $( document ).ready(function() {
            $('#vendorAttacheds').dropzone({
                url: "/public/dashboard/apk/attacheds", // Set the url for your upload script location
                            ...
                            <div class="card card-custom">
                                <div class="card-header ribbon ribbon-top ribbon-ver">
                                    <div class="ribbon-target bg-success" style="top: -2px; right: 20px;">
                                        <a href="{{route('delete.attachment.apk', $at->id)}}"><i class="fas fa-trash text-white"></i></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                        <img style="width: 100%;height: auto;" src="{{$at->name}}">
                                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-footer">
                   <button onclick="location.reload()" class="btn btn-primary mr-2">@lang('form.update')</button> 
                </div>
        </div>
    </div>
@endsection
