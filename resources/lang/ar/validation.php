...
return [
    ...
    'attributes' => [
        ...
        'packageOrder.stock' => 'الكمية',
        'stok' => 'الكمية',
        'pricing' => 'السعر',
        'packageOrder.pricing' => 'السعر',
        'mainPackageHours.pricing' => 'السعر',
        'start' => 'البداية',
        'starts' => 'البداية',
        'packageOrder.start' => 'البداية',
        'mainPackageHours.start' => 'البداية',
        'mainPackageHours.drivers' => 'السائقين',
        'end' => 'النهاية',
        'mainPackageHours.end' => 'النهاية',
        'packageOrder.end' => 'النهاية',
        'available' => 'مُتاح',
        'city' => 'المحافظة',
        'content' => 'المُحتوى',
        'country' => 'الدولة',
        ...
        'long' => 'الطول',
        'area_id' => 'المدينة',
        'method_id' => 'نوع المركبة',
        'to_address' => 'عنوان صاحب الطلب',
        'from_address' => 'عنوان المتجر',
        'delivery_id' => 'السائق مطلوب',
        'type_order' => 'نوع الطلب',
        'lat_from' => 'عنوان المتجر',
        'long_from' => 'عنوان الطول للمتجر',
        'lat_to' => 'عنوان الطلبية',
        'long_to' => 'عنوان الطول لطلبية',
        ...
        's_old_password' => 'كلمة المرور',
        's_new_password' => 'كلمة المرور الجديدة',
        's_password_confirmation' => 'تأكيد كلمة المرور',
    ],
];
